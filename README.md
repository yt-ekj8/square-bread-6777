...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-bread-6777
```

A live public deployment of this template is available at [https://square-bread-6777.templates.workers.dev](https://square-bread-6777.templates.workers.dev)
